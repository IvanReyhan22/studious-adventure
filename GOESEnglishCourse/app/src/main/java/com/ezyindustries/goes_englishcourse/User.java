...
public class User {
    private String username, nickname, email, phone,Lesson, Tes, Latihan,Gender, deskripsion, website, picUrl;

    public User(){}

    public User(String username, String nickname, String email, String phone, String lesson, String tes, String latihan, String gender, String deskripsion, String website, String picUrl) {
